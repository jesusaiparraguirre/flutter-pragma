...
class ExpandableTextWidget extends StatefulWidget {
  ...
  final String? expandTextFontFamily;
...
class ExpandableTextWidgetState extends State<ExpandableTextWidget>
  ...
  Widget build(BuildContext context) {
    ...
    final linkTextStyle = effectiveTextStyle!.merge(widget.linkStyle).copyWith(
          color: linkColor,
          fontSize: widget.expandTextFontSize,
          fontWeight: widget.expandTextFontWeight,
          fontFamily: widget.expandTextFontFamily
        );
    ...
    final double minWidth = MediaQuery.of(context).size.width * 0.2;
    print("max $maxWidth min $minWidth");
